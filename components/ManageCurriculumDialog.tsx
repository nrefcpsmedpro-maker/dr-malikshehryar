              ...
              {isPending && !course ? (
                 ...
                 <>
                   ...
                   <div className="space-y-4">
                      {course?.subjects?.sort((a: CourseSubject, b: CourseSubject) => a.order_index - b.order_index).map((subject: CourseSubject, subjectIndex: number) => {
                            ...
                            {isExpanded && !isEditingThisSubject && (
                               <div className="p-4 pt-0 bg-secondary/5 animate-in slide-in-from-top-2 duration-200">
                                  ...
                                  <div className="space-y-1 pl-1 border-l-2 border-primary/20 ml-2 mt-2">
                                     {subject.lessons?.sort((a: CourseLesson, b: CourseLesson) => a.order_index - b.order_index).map((lesson: CourseLesson, lessonIndex: number) => {
